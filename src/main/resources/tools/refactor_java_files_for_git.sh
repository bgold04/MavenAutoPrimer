...
# refactor java files for https://github.com/bgold04/MavenAutoPrimer on 20250123

cd /Users/bgold/MavenAutoPrimer
...
git add src/main/java/com/github/MisprimingLibraryBuilder.java
git add src/main/java/com/github/Primer3ResultsController.java
git add src/main/java/com/github/UcscBuildAndTableFetcher.java
git add src/main/java/com/github/UcscGeneCoordinatesFetcher.java
git add src/main/resources/tools/
