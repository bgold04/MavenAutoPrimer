...
mv "$SRC_DIR/MavenAutoPrimer.java" "$SRC_DIR/AutoPrimerApplication.java"
mv "$SRC_DIR/MavenAutoPrimerConfig.java" "$SRC_DIR/ApplicationConfig.java"
...
mv "$SRC_DIR/GeneCoordinatesFetcher.java" "$SRC_DIR/GeneCoordinatesFetcher.java"
...
mv "$SRC_DIR/RefactorMavenAutoPrimer.java" "$SRC_DIR/AutoPrimerRefactorer.java"
