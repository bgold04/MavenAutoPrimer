...
#./extract_overview.sh ~/MavenAutoPrimerA/src/com/github/mavenautoprimer/MavenAutoPrimer.java
#./extract_overview.sh ~/Documents/AutoPrimer3/src/com/github/autoprimer3/AutoPrimer3.java


#This creates an overview of MavenAutoPrimer.java.txt in the same directory as the script
#overview_AutoPrimer3.java.txt in the same directory as the script
Move the Overview Files to the Work Directory
Move the generated files to your ~/MavenAutoPrimerA/work directory:

# Move the Overview Files to the Work Directory
#mv overview_MavenAutoPrimer.java.txt ~/MavenAutoPrimerA/work/
#mv overview_AutoPrimer3.java.txt ~/MavenAutoPrimerA/work/
...
sdiff -w 200 -s ~/MavenAutoPrimerA/work/overview_MavenAutoPrimer.java.txt ~/MavenAutoPrimerA/work/overview_AutoPrimer3.java.txt > ~/MavenAutoPrimerA/work/comparison_AutoPrimer3_overview.txt
...
#open resulting file
#less ~/MavenAutoPrimerA/work/comparison_AutoPrimer3_overview.txt
Resulting File
#The file comparison_AutoPrimer3_overview.txt will have two columns:

#Column 1: Overview of MavenAutoPrimer.java
